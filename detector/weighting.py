...
def fit_transform(para, X_seq, term_weighting=None, normalization=None, \
    ...
    ---------
        ...
        df_vec_inc: sync with incremental feature extract update
    ...
    if term_weighting == 'tf-idf':
        ...
        if df_vec_inc:
            ...
            np.save(para['persist_path']+'idf_vector_train_static.npy', idf_vec)
...
def transform(para, X_seq, term_weighting=None, normalization=None, \
    ...
    if term_weighting == 'tf-idf':
        if use_train_factor:
            ...
            if df_vec_inc:
                ...
                idf_vec = np.load(para['persist_path']+'idf_vector_train_static.npy')
            #print(idf_vec)
        else:
