...
# List of intergers and tuples like xxx = 1 2 3 4, (12-11.1) (10-11) as
# well as Numbers including hex, decimal and integer
regexPattern6 = re.compile(
    r'(?<=value=)(( [a-f0-9]{2}){14})'
    r'|(?<=HEX:)([A-F0-9]{2} )+'
