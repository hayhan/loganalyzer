...
rawfile_labeled = open(raw_file_labeled_loc, 'r', encoding='utf-8')
...
raw_dup_file = open(raw_dup_loc, 'w', encoding='utf-8')
new_dup_file = open(new_dup_loc, 'w', encoding='utf-8')
